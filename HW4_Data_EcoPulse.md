...
![Топ-20 лемм для классов critical и not_critical](hw4/pic/eda_top_words_lemmatized.png)
...
![Распределение постов bank_reviews по времени](hw4/pic/eda_time_distribution.png)
...
![TimeSeriesSplit - 5 фолдов (синий - train, красный - val)](hw4/pic/eda_timeseries_split.png)
